...
Each card has a `getTextRepresentation()` method that returns a simple text-based representation of the card, suitable for console output, alt text for accessibility, or other text-only interfaces.
