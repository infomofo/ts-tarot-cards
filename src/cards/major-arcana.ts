import { TarotCard, Arcana, MajorArcana } from '../types';

// Example major arcana cards - extensible to full deck
export const MAJOR_ARCANA_CARDS: Partial<Record<MajorArcana, TarotCard>> = {
  [MajorArcana.TheFool]: {
    id: 'major-00-fool',
    name: 'The Fool',
    arcana: Arcana.Major,
    majorArcana: MajorArcana.TheFool,
  ...
  [MajorArcana.TheMagician]: {
    ...
    name: 'The Magician',
    arcana: Arcana.Major,
    majorArcana: MajorArcana.TheMagician,
...
export function getMajorArcanaCard(arcana: MajorArcana): TarotCard | undefined {
