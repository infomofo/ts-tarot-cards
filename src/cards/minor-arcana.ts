...
export function createMinorArcanaCard(
  ...
  return new MinorArcanaCardImpl(
    suit,
    number,
    keywords,
    uprightMeanings,
...
export const MINOR_ARCANA_CARDS: Partial<Record<MinorArcana, MinorArcanaCard>> = {
  ...
  [MinorArcana.SixOfCups]: createMinorArcanaCard(
    Suit.Cups,
    MinorNumber.Six,
    ['nostalgia', 'childhood', 'reunion', 'innocence'],
  ...
  [MinorArcana.NineOfCups]: createMinorArcanaCard(
    Suit.Cups,
    MinorNumber.Nine,
    ['wishes fulfilled', 'satisfaction', 'contentment'],
  ...
  [MinorArcana.TenOfCups]: createMinorArcanaCard(
    Suit.Cups,
    MinorNumber.Ten,
    ['harmony', 'marriage', 'happiness', 'family'],
  ...
  [MinorArcana.QueenOfCups]: createMinorArcanaCard(
    Suit.Cups,
    MinorNumber.Queen,
    ['compassion', 'calm', 'intuition', 'nurturing'],
  ...
  [MinorArcana.TwoOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.Two,
    ['balancing', 'juggling', 'flexibility'],
  ...
  [MinorArcana.FourOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.Four,
    ['control', 'stability', 'security', 'possessiveness'],
  ...
  [MinorArcana.EightOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.Eight,
    ['skill', 'mastery', 'diligence', 'apprenticeship'],
  ...
  [MinorArcana.PageOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.Page,
    ['new opportunities', 'manifestation', 'learning'],
  ...
  [MinorArcana.KnightOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.Knight,
    ['hard work', 'responsibility', 'routine'],
  ...
  [MinorArcana.KingOfPentacles]: createMinorArcanaCard(
    Suit.Pentacles,
    MinorNumber.King,
    ['wealth', 'success', 'leadership', 'security'],
  ...
  [MinorArcana.AceOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Ace,
    ['breakthrough', 'clarity', 'truth', 'power'],
  ...
  [MinorArcana.TwoOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Two,
    ['stalemate', 'indecision', 'truce', 'avoidance'],
  ...
  [MinorArcana.FiveOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Five,
    ['conflict', 'defeat', 'winning at all costs'],
  ...
  [MinorArcana.SixOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Six,
    ['transition', 'moving on', 'rite of passage'],
  ...
  [MinorArcana.SevenOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Seven,
    ['deception', 'theft', 'strategy', 'betrayal'],
  ...
  [MinorArcana.EightOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Eight,
    ['imprisonment', 'limitation', 'victim mentality'],
  ...
  [MinorArcana.TenOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Ten,
    ['failure', 'betrayal', 'rock bottom', 'endings'],
  ...
  [MinorArcana.PageOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Page,
    ['curiosity', 'truth', 'communication', 'energy'],
  ...
  [MinorArcana.KnightOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Knight,
    ['ambition', 'action', 'haste', 'assertiveness'],
  ...
  [MinorArcana.QueenOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.Queen,
    ['independence', 'clarity', 'intelligence'],
  ...
  [MinorArcana.KingOfSwords]: createMinorArcanaCard(
    Suit.Swords,
    MinorNumber.King,
    ['authority', 'truth', 'justice', 'intellect'],
  ...
  [MinorArcana.TwoOfWands]: createMinorArcanaCard(
    Suit.Wands,
    MinorNumber.Two,
    ['planning', 'decisions', 'future', 'potential'],
  ...
  [MinorArcana.ThreeOfWands]: createMinorArcanaCard(
    Suit.Wands,
    MinorNumber.Three,
    ['expansion', 'foresight', 'long-term success'],
  ...
  [MinorArcana.PageOfWands]: createMinorArcanaCard(
    Suit.Wands,
    MinorNumber.Page,
    ['inspiration', 'ideas', 'discovery', 'free spirit'],
  ...
  [MinorArcana.QueenOfWands]: createMinorArcanaCard(
    Suit.Wands,
    MinorNumber.Queen,
    ['courage', 'confidence', 'independence', 'social'],
  ...
  [MinorArcana.KingOfWands]: createMinorArcanaCard(
    Suit.Wands,
    MinorNumber.King,
    ['leadership', 'vision', 'creativity', 'entrepreneur'],
